  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--bg-base)' }}>
      <section className="py-20 md:py-28 px-6 max-w-4xl mx-auto text-center">
        ...
        <p className="text-base md:text-lg max-w-xl mx-auto leading-relaxed animate-fade-up delay-2" style={{ color: 'var(--text-secondary)' }}>SwiftCare is an AI-powered platform built by four engineering students to eliminate the ER waiting room bottleneck.</p>
      </section>
